...
//    public CustomTableData nestedTable;
//    TableCell(){
//        data = new String("");
...
//    CustomTableData(JSONObject JsonObj){
...
//                    if(CellObject.containsKey("nested_table")){
//                        cell.nestedTable = new CustomTableData((JSONObject)CellObject.get("nested_table"));
//                    }
//                    cell_count++;
//                }
//                row_count++;
...
//        }
//        if(CellFormatting.containsKey("padding")){
//            JSONArray  tempArray = (JSONArray) CellFormatting.get("padding");
//            Iterator tempIterator = tempArray.iterator();
//            cell.formatting.Padding = new int[tempArray.size()];
//
//            int count = 0;
//            while(tempIterator.hasNext()){
//                Long value = (Long)tempIterator.next();
//                cell.formatting.Padding[count++] = new Integer(value.intValue());
//            }
//
//        }
//    }
